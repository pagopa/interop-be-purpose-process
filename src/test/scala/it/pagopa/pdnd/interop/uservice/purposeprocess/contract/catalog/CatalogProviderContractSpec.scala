package it.pagopa.pdnd.interop.uservice.purposeprocess.contract.catalog

import com.itv.scalapact.model.ScalaPactDescription
import com.itv.scalapact.{ScalaPactMockConfig, ScalaPactMockServer}
import it.pagopa.pdnd.interop.uservice.purposeprocess.server.impl.CatalogManagementDependency
...
class CatalogProviderContractSpec
  ...
  val CONSUMER = "purpose-process-consumer"
